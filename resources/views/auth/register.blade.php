...
<main class="auth-shell">
    <section class="auth-card">
        <div class="text-center">
            <span class="brand-mark"><i class="bi bi-person-plus"></i></span>
            <h1 class="auth-title">Register KELUH.IN</h1>
            <p class="auth-subtitle">Buat akun baru untuk mengakses sistem admin.</p>
        </div>
        ...
        <p class="text-center mt-4 mb-0 text-muted">
            Sudah punya akun?
            <a class="auth-link" href="/admin/login">Login</a>
        </p>
    </section>
</main>
</body>
